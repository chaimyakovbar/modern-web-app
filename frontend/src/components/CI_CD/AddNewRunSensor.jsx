...
import { SENSORS } from "../consts/Sensors";

function AddNewRunSensor({ onNewRun, onBack, onClose }) {
  ...
  const getFilteredProducts = () => {
    ...
    return SENSORS.filter((product) => product.type === filterType);
  };
            ...
            <Box sx={{ display: "flex", gap: 2 }}>
              ...
              >
                <Box sx={{ mb: 2 }}>
                  ...
                  >
                    Selected: {selectedProducts.length} / {SENSORS.length}
                  </Typography>
                  <Box
                    sx={{
                      display: "flex",
...
export default AddNewRunSensor;
